...
import { incomeCategories, expenseCategories, expenseTypes } from "../../data/data";
  ...
  function handleFormSubmit(datas) {
    ...
    addTransaction(newTransaction, {
      onSuccess: ([data]) => {
        ...
        const categorySavings = savings.find((saving) => saving.funded_by === data.category);
  ...
  return (
    <Modal>
      <div className="border-2 border-light-dividers p-3 rounded-md w-4/5 bg-light-background dark:bg-dark-background">
        <h1 className="text-xl font-bold text-light-text p-2 mb-2 dark:text-dark-text">
          {isEdit ? `Edit ${data.category} ${data.type} transaction.` : "Add a new transaction"}
        </h1>
        <Form
        ...
        >
          ...
          <div className="flex justify-between items-center gap-2">
            <Button
              ...
              disable={isAddingTransaction || isEditingTransaction}
