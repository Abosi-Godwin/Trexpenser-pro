...
const UserSettings = () => {
    ...
    return (
        <>
            {openPicForm && (
                <UpdatePicForm onClose={() => setOpenPicForm(false)} />
            )}
        ...
        dark:text-dark-text rounded-md p-3 flex flex-col gap-4"
            >
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        {joinedDate && (
                            <>
                                ...
                                <span
                                    className="text-xs w-fit bg-light-primaryCTA/10
                ...
                py-1.5 rounded-md font-bold text-sm transition-colors"
                    ...
                    rounded-md font-bold text-sm disabled:opacity-60"
                                />
                                <Button
                                    text="Cancel"
                                    disabled={isDeleting}
                    ...
                    dark:bg-dark-sectionBackground px-3 py-1.5 
